...
// * Modified slightly for hydna-unity-chicken demo
...
public class ThirdPersonController : MonoBehaviour 
{
	...
	public float inflate_size = 3.5f;
	...
	private void UpdateSkin(){
		...
		if (currentSkin) {
			scale = currentSkin.transform.localScale;
		} else {
		...
		currentSkin.transform.localScale = scale;
		currentSkin.SetActive (true);

		_animation = currentSkin.GetComponent<Animation>();
	}
